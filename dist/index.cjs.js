...
var css_248z = ":where(.overlay-library){box-sizing:border-box;font-family:inherit;line-height:inherit}:where(.overlay-library *),:where(.overlay-library :after),:where(.overlay-library :before){box-sizing:inherit;margin:0;padding:0}:where(.overlay-library h1,.overlay-library h2,.overlay-library h3,.overlay-library h4,.overlay-library h5,.overlay-library h6,.overlay-library p,.overlay-library figure,.overlay-library blockquote,.overlay-library pre){margin:0;padding:0}:where(.overlay-library ul,.overlay-library ol){list-style:none;padding:0}:where(.overlay-library button,.overlay-library input,.overlay-library select,.overlay-library textarea){background:none;border:none;font:inherit;outline:none}:where(.overlay-library img,.overlay-library video){display:block;height:auto;max-width:100%}:where(.overlay-library a){color:inherit;text-decoration:none}:where(.overlay-library html){overflow-x:hidden}:where(.overlay-library body){-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-rendering:optimizeLegibility}:where(.overlay-library button:focus,.overlay-library input:focus,.overlay-library select:focus,.overlay-library textarea:focus){outline:2px solid var(--focus-color,#007aff);outline-offset:2px}:where(.overlay-library .overlay-portal){overflow:hidden}@media (prefers-reduced-motion:reduce){:where(.overlay-library *){animation:none!important;transition:none!important}}:root{--overlay-primary-color:#007aff;--overlay-secondary-color:#0051cb;--overlay-text-color:#1a1a1a;--overlay-bg-color:#fff;--overlay-dark-primary:#0a84ff;--overlay-dark-secondary:#05f;--overlay-dark-text:#fff;--overlay-dark-bg:#000;--overlay-font-family:system-ui,-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,sans-serif;--overlay-font-size-sm:14px;--overlay-font-size-md:16px;--overlay-font-size-lg:18px;--overlay-font-weight-light:300;--overlay-font-weight-normal:400;--overlay-font-weight-bold:600;--overlay-padding-sm:8px;--overlay-padding-md:12px;--overlay-padding-lg:16px;--overlay-gap-sm:4px;--overlay-gap-md:8px;--overlay-gap-lg:12px;--overlay-border-radius:12px;--overlay-shadow-sm:0px 2px 5px rgba(0,0,0,.1);--overlay-shadow-md:0px 4px 10px rgba(0,0,0,.15);--overlay-shadow-lg:0px 6px 20px rgba(0,0,0,.2);--overlay-border-color:rgba(0,0,0,.1);--overlay-border-width:1px;--compact-width:120px;--compact-height:36px;--expanded-width:350px;--expanded-height:120px;--di-duration-fast:150ms;--di-duration-normal:300ms;--di-transition-timing:ease-in-out;--di-spring-timing:cubic-bezier(0.34,1.56,0.64,1);--overlay-transition:0.3s ease-in-out;--overlay-scale-hover:1.02;--overlay-z-index:1000}@media (prefers-color-scheme:dark){:root{--overlay-primary-color:var(--overlay-dark-primary);--overlay-secondary-color:var(--overlay-dark-secondary);--overlay-text-color:var(--overlay-dark-text);--overlay-bg-color:var(--overlay-dark-bg);--overlay-border-color:hsla(0,0%,100%,.1)}}@keyframes overlay-expand{0%{opacity:.8;transform:scale(.96)}to{opacity:1;transform:scale(1)}}@keyframes overlay-collapse{0%{transform:scale(1)}to{transform:scale(.96)}}@keyframes overlay-swipe-left{0%{opacity:1;transform:translateX(0)}to{opacity:0;transform:translateX(-100%)}}@keyframes overlay-swipe-right{0%{opacity:1;transform:translateX(0)}to{opacity:0;transform:translateX(100%)}}@keyframes slide-left{0%{transform:translateX(0)}to{transform:translateX(-100%)}}@keyframes slide-right{0%{transform:translateX(0)}to{transform:translateX(100%)}}@keyframes alert-pulse{0%,to{box-shadow:0 0 0 0 rgba(var(--di-alert-rgb,255,69,58),.4);transform:scale(1)}50%{box-shadow:0 0 0 10px rgba(var(--di-alert-rgb,255,69,58),0);transform:scale(1.03)}}:where(.overlay-library){color:var(--overlay-text-color);font-family:var(--overlay-font-family);font-size:var(--overlay-font-size-md);line-height:1.5}:where(.overlay-library .overlay-container){align-items:center;display:flex;flex-direction:column;gap:var(--overlay-gap-md);left:50%;max-width:90vw;padding:var(--overlay-padding-md);position:fixed;top:0;transform:translateX(-50%);width:auto;z-index:var(--overlay-z-index)}:where(.overlay-library .overlay-flex){align-items:center;display:flex;gap:var(--overlay-gap-sm);justify-content:center}:where(.overlay-library .overlay-grid){display:grid;gap:var(--overlay-gap-md)}:where(.overlay-library .overlay-hidden){display:none!important}:where(.overlay-library .overlay-visible){display:block!important}:where(.overlay-library .overlay-scroll){max-height:80vh;overflow:auto}:where(.overlay-library button,.overlay-library input,.overlay-library select){cursor:pointer}:where(.overlay-library button:focus,.overlay-library input:focus){outline:2px solid var(--overlay-primary-color);outline-offset:2px}@media (max-width:768px){:where(.overlay-library .overlay-container){padding:var(--overlay-padding-sm);width:95vw}}.overlay-styled .overlay-card--expanded{backdrop-filter:blur(calc(var(--di-glass-blur, 12px)*1.2));-webkit-backdrop-filter:blur(calc(var(--di-glass-blur, 12px)*1.2));border-radius:var(--di-expanded-radius,32px);box-shadow:0 12px 36px rgba(0,0,0,.2);transform:translateY(var(--di-expanded-offset,16px))}.overlay-styled .overlay-card--collapsed,.overlay-styled .overlay-card--expanded{opacity:1;transition:width var(--di-duration-normal) var(--di-transition-timing),height var(--di-duration-normal) var(--di-transition-timing),transform var(--di-duration-normal) var(--di-transition-timing),opacity var(--di-duration-fast) ease-out,visibility 0s linear;visibility:visible}.overlay-styled .overlay-card--collapsed{border-radius:calc(var(--overlay-collapsed-height, 36px)/2);transform:none}.overlay-styled .overlay-card--hidden{opacity:0;pointer-events:none;transform:translateY(-100%);transition:opacity var(--di-duration-fast) ease-out,transform var(--di-duration-normal) ease-out,visibility 0s linear var(--di-duration-normal);visibility:hidden}.overlay-styled .overlay-card--alert,.overlay-styled .overlay-card--hidden{height:var(--overlay-collapsed-height,36px);width:var(--overlay-collapsed-width,120px)}.overlay-styled .overlay-card--alert{animation:alert-pulse 2s ease-in-out infinite;backdrop-filter:none;-webkit-backdrop-filter:none;background-color:var(--di-alert-bg,rgba(255,69,58,.95));border-radius:calc(var(--overlay-collapsed-height, 36px)/2);opacity:1;transform:none;visibility:visible}.overlay-styled .overlay-card:focus-visible{box-shadow:0 0 0 3px var(--di-focus-ring,rgba(0,122,255,.8));outline:none}.overlay-styled .overlay-portal{backdrop-filter:blur(var(--di-glass-blur,16px));-webkit-backdrop-filter:blur(var(--di-glass-blur,16px));background-color:rgba(var(--di-background-rgb,18,18,18),var(--di-glass-opacity,.75));border-radius:var(--overlay-border-radius);box-shadow:0 8px 24px rgba(0,0,0,.2);color:var(--di-text,#fff);cursor:pointer;height:var(--compact-height);left:0;overflow:hidden;top:var(--di-top-offset,12px);transform:none;transition:width .3s var(--di-transition-timing),height .3s var(--di-transition-timing),transform .3s var(--di-transition-timing),opacity .2s ease-out,visibility 0s linear,background-color .15s ease-in-out,backdrop-filter .15s ease-in-out,box-shadow .3s var(--di-transition-timing),border-radius .3s var(--di-transition-timing);user-select:none;width:var(--compact-width);will-change:transform,width,height,opacity,visibility;z-index:var(--di-z-index,9999)}.overlay-styled .overlay-portal[data-state=expanded]{height:var(--overlay-expanded-height,120px);width:var(--overlay-expanded-width,350px)}.overlay-styled .overlay-portal[data-state=collapsed]{height:var(--overlay-collapsed-height,36px);width:var(--overlay-collapsed-width,120px)}.overlay-styled .overlay-portal:focus-visible{outline:2px solid var(--overlay-focus-ring,rgba(0,122,255,.8));outline-offset:2px}.overlay-styled .overlay-container{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;display:flex;justify-content:center;opacity:1;padding:var(--overlay-padding,8px);transition:transform .2s ease-in-out}.overlay-styled .overlay-portal:empty{display:none;pointer-events:none}.overlay-styled .overlay-portal[data-hidden=true]{opacity:0;transition:opacity .2s ease-in-out,visibility 0s linear .2s;visibility:hidden}.overlay-styled .overlay-container[data-animating=true]{transform:scale(.98)}.overlay-styled .overlay-portal[data-channel] .overlay-container{overflow:hidden;position:relative}.overlay-styled .overlay-container[data-direction=next]{animation:slide-left .2s ease-out forwards}.overlay-styled .overlay-container[data-direction=prev]{animation:slide-right .2s ease-out forwards}.overlay-styled .overlay-multiple-container{align-items:flex-start;display:flex;flex-wrap:wrap;gap:var(--overlay-gap-lg,12px);justify-content:center}@media (max-width:480px){.overlay-styled .overlay-multiple-container{align-items:center;flex-direction:column}}.overlay-styled .overlay-card{border-radius:var(--overlay-border-radius);box-shadow:var(--di-shadow);cursor:pointer;display:flex;flex-direction:column;font-size:var(--overlay-font-size-md);gap:var(--overlay-gap-sm);max-width:350px;padding:var(--overlay-padding-md);transform-origin:center;transition:width var(--di-duration-normal) var(--di-transition-timing),height var(--di-duration-normal) var(--di-transition-timing),transform var(--di-duration-fast) var(--di-transition-timing),opacity var(--di-duration-fast) var(--di-transition-timing),box-shadow .3s var(--di-transition-timing),background-color .15s ease-in-out,backdrop-filter .2s ease-in-out;user-select:none;width:fit-content;will-change:width,height,transform,opacity}.overlay-styled .overlay-card--collapsed{align-items:center;animation:overlay-collapse var(--di-duration-normal) var(--di-transition-timing);height:var(--overlay-collapsed-height,36px);justify-content:center;min-width:var(--overlay-collapsed-width,120px);overflow:hidden;padding:var(--overlay-padding-sm);text-align:center;width:var(--overlay-collapsed-width,120px)}.overlay-styled .overlay-card--expanded{animation:overlay-expand var(--di-duration-normal) var(--di-transition-timing);height:var(--overlay-expanded-height,120px);justify-content:space-between;padding:var(--overlay-padding-lg);width:var(--overlay-expanded-width,350px)}.overlay-styled .overlay-card-title{font-size:var(--overlay-font-size-lg);font-weight:var(--overlay-font-weight-bold);text-align:center}.overlay-styled .overlay-card-body{font-size:var(--overlay-font-size-md);opacity:0;text-align:center;transition:opacity var(--di-duration-normal) var(--di-transition-timing)}.overlay-styled .overlay-card--expanded .overlay-card-body{opacity:1}.overlay-styled .overlay-card:hover{box-shadow:var(--di-shadow);transform:scale(var(--di-hover-scale))}.overlay-styled .overlay-card:active{transform:scale(var(--di-active-scale))}.overlay-styled .overlay-card--swipe-left{animation:overlay-swipe-left .2s ease-out forwards}.overlay-styled .overlay-card--swipe-right{animation:overlay-swipe-right .2s ease-out forwards}.overlay-styled .overlay-card-actions{align-items:center;display:flex;justify-content:space-between;margin-top:var(--overlay-gap-md)}.overlay-styled .overlay-card-remove{background:transparent;border:none;color:var(--overlay-text-color);cursor:pointer;font-size:18px;padding:var(--overlay-padding-sm);transition:var(--overlay-transition)}.overlay-styled .overlay-card-remove:hover{opacity:.7}.overlay-styled .overlay-card-swipe-next,.overlay-styled .overlay-card-swipe-prev{background:var(--overlay-primary-color);border-radius:var(--overlay-border-radius);color:#fff;cursor:pointer;font-size:var(--overlay-font-size-md);padding:var(--overlay-padding-sm) var(--overlay-padding-md);transition:var(--overlay-transition)}.overlay-styled .overlay-card-swipe-next:hover,.overlay-styled .overlay-card-swipe-prev:hover{background:var(--overlay-secondary-color)}.overlay-styled .overlay-card-swipe-next:disabled,.overlay-styled .overlay-card-swipe-prev:disabled{cursor:not-allowed;opacity:.4}.overlay-styled .overlay-card-swipe-prev{margin-right:auto}.overlay-styled .overlay-card-swipe-next{margin-left:auto}:root{--di-background:hsla(0,0%,7%,.75);--di-background-solid:#121212;--di-background-rgb:18,18,18;--di-text:hsla(0,0%,100%,.97);--di-shadow:rgba(0,0,0,.35);--di-focus-ring:hsla(0,0%,100%,.7);--di-glass-opacity:0.75;--di-glass-blur:16px;--di-glass-border:hsla(0,0%,100%,.1);--di-glass-shadow-primary:rgba(0,0,0,.35);--di-glass-shadow-secondary:rgba(0,0,0,.25);--di-hover-scale:1.03;--di-active-scale:0.97;--di-hover-brightness:1.1;--di-active-brightness:0.9;--di-accent:#0a84ff;--di-accent-gradient:linear-gradient(120deg,#0a84ff,#06c);--di-alert-bg:rgba(255,69,58,.97);--di-alert-rgb:255,69,58;--di-success-bg:rgba(48,209,88,.97);--di-success-rgb:48,209,88;--di-warning-bg:rgba(255,214,10,.97);--di-warning-rgb:255,214,10;--di-error-bg:rgba(255,69,58,.97);--di-error-rgb:255,69,58}[data-theme=light]{--di-background:hsla(0,0%,98%,.75);--di-background-solid:#fafafa;--di-background-rgb:250,250,250;--di-text:hsla(0,0%,4%,.97);--di-shadow:rgba(0,0,0,.2);--di-focus-ring:rgba(0,0,0,.3);--di-glass-border:rgba(0,0,0,.1);--di-glass-shadow-primary:rgba(0,0,0,.2);--di-glass-shadow-secondary:rgba(0,0,0,.15)}html{transition:background-color .3s ease-in-out,color .3s ease-in-out}.overlay-styled .overlay-card{box-shadow:0 6px 16px var(--di-shadow)}.overlay-styled .overlay-card,.overlay-styled .overlay-portal{backdrop-filter:blur(var(--di-glass-blur));-webkit-backdrop-filter:blur(var(--di-glass-blur));background-color:var(--di-background);border:1px solid var(--di-glass-border);color:var(--di-text)}.overlay-styled .overlay-portal{box-shadow:0 8px 24px var(--di-shadow);transition:background-color .2s ease-in-out,box-shadow .2s ease-in-out,border-color .2s ease-in-out}[data-theme=light] .overlay-styled .overlay-card{background-color:var(--di-background);border:1px solid var(--di-glass-border);box-shadow:0 4px 12px var(--di-shadow);color:var(--di-text)}.overlay-card:focus-visible{outline:2px solid var(--di-focus-ring);outline-offset:3px}.overlay-styled .overlay-card{transition:background-color .2s ease-in-out,box-shadow .2s ease-in-out,border-color .2s ease-in-out,color .2s ease-in-out}";
...
function useAggregator() {
    const context = require$$0.useContext(AggregatorContext);
    if (!context) {
     ...
     */
    const registerChannel = require$$0.useCallback((channelId, priority) => {
     ...
     */
    const unregisterChannel = require$$0.useCallback((channelId) => {
     ...
     */
    const setActiveChannel = require$$0.useCallback((channelId) => {
     ...
     */
    const updateChannelState = require$$0.useCallback((channelId, newState) => {
        dispatch({
     ...
     */
    const addCard = require$$0.useCallback((channelId, card) => {
     ...
     */
    const removeCard = require$$0.useCallback((channelId, cardId) => {
     ...
     */
    const clearChannelCards = require$$0.useCallback((channelId) => {
     ...
     */
    const swipeNextCard = require$$0.useCallback((channelId) => {
     ...
     * @param channelId The channel in which we navigate.
     */
    const swipePrevCard = require$$0.useCallback((channelId) => {
     ...
     */
    const getChannel = require$$0.useCallback((channelId) => {
        return state.channels[channelId];
    }, [state]);
    /**
     * Returns the currently active channel (if any), or null if none is active.
     */
    const getActiveChannel = require$$0.useCallback(() => {
     ...
     */
    const getActiveCard = require$$0.useCallback((channelId) => {
...
function OverlayCard({ channelId, card }) {
    ...
    const touchStartX = require$$0.useRef(null);
    const touchDeltaX = require$$0.useRef(0);
    const swipeTriggered = require$$0.useRef(false);
    const [direction, setDirection] = require$$0.useState(null);
...
function OverlayPortal({ concurrencyMode = 'single', portalRoot, unstyled }) {
    ...
    if (concurrencyMode === 'single') {
        ...
        if (!activeCard)
            return null;
        return ReactDOM.createPortal(jsxRuntimeExports.jsx("div", { className: overlayClass, children: jsxRuntimeExports.jsx(DefaultOverlay, { channelId: activeChannel.channelId, cardId: activeCard.id }) }), portalRoot || document.body);
    }
    ...
    if (activeChannels.length === 0)
        return null;
    return ReactDOM.createPortal(jsxRuntimeExports.jsx("div", { className: overlayClass, children: jsxRuntimeExports.jsx("div", { className: "overlay-multiple-container", children: activeChannels.map((channel) => {
                const activeCard = getActiveCard(channel.channelId);
                return activeCard ? jsxRuntimeExports.jsx(DefaultOverlay, { channelId: channel.channelId, cardId: activeCard.id }, channel.channelId) : null;
 ...
 */
function DefaultOverlay({ channelId, cardId }) {
    ...
    if (!card)
        return null;
    return (jsxRuntimeExports.jsx("div", { className: "overlay-container", children: jsxRuntimeExports.jsx("div", { className: "overlay-portal", "data-state": channel.state, children: jsxRuntimeExports.jsx(OverlayCard, { channelId: channelId, card: card }) }) }));
}
 ...
 */
function AggregatorProvider({ children, concurrencyMode = 'single', autoDismiss = false, autoDismissTimeout = 3000, debug = false, portalRoot, unstyled = false, }) {
    const [state, baseDispatch] = require$$0.useReducer(aggregatorReducer, initialAggregatorState);
    ...
    const debugDispatch = require$$0.useCallback((action) => {
        if (debug) {
